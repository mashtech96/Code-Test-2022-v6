...
class BookingRepository extends BaseRepository
{
    ...
    public function getUsersJobs($user_id)
    {
        try {
            ...
            return successResponse(config("constants.SUCESS_TO_KEY_TO_GIVE"), $data);
        } catch (\Exception $e) {
    ...
    public function jobToData($job)
    {
        try {
            ...
            return successResponse(config("constants.SUCCESS_TO_KEY_TO_GIVE"), $data);
        } catch (\Exception $e) {
            //or $e->getMessage() if you want to get exact error
            return errorResponse(config("constants.ERROR_TO_KEY_TO_GIVE"));
        }
    ...
    public function getPotentialJobIdsWithUserId($user_id)
    {
        try {
            ...
            return successResponse(config("constants.SUCCESS_TO_KEY_TO_GIVE"), $jobs);
        } catch (\Exception $e) {
            //or $e->getMessage() if you want to get exact error
            return errorResponse(config("constants.ERROR_TO_KEY_TO_GIVE"));
        }
    ...
    public function sendSMSNotificationToTranslator($job)
    {
        try {
            ...
            return successResponse(config("constants.SUCCESS_TO_KEY_TO_GIVE"), count($translators));
        } catch (\Exception $e) {
            //or $e->getMessage() if you want to get exact error
            return errorResponse(config("constants.ERROR_TO_KEY_TO_GIVE"));
        }
    ...
    public function getPotentialTranslators(Job $job)
    {
        try {
            ...
            return successResponse(config("constants.ERROR_TO_KEY_TO_GIVE"), $users);
        } catch (\Exception $e) {
            //or $e->getMessage() if you want to get exact error
            return errorResponse(config("constants.ERROR_TO_KEY_TO_GIVE"));
        }
    ...
    public function getPotentialJobs($cuser)
    {
        try {
            ...
            //        $jobs = TeHelper::convertJobIdsInObjs($job_ids);
            return successResponse(config("constants.SUCCESS_TO_KEY_TO_GIVE"), $job_ids);
        } catch (\Exception $e) {
            //or $e->getMessage() if you want to get exact error
            return errorResponse(config("constants.ERROR_TO_KEY_TO_GIVE"));
        }
    ...
    public function getAll(Request $request, $limit = null)
    {
        try {
            ...
            return successResponse(config("constants.ERROR_TO_KEY_TO_GIVE"), $allJobs);
        } catch (\Exception $e) {
            //or $e->getMessage() if you want to get exact error
            return errorResponse(config("constants.ERROR_TO_KEY_TO_GIVE"));
        }
    ...
    public function alerts()
    {
        try {
            ...
            $data = ['allJobs' => $allJobs, 'languages' => $languages, 'all_customers' => $all_customers, 'all_translators' => $all_translators, 'requestdata' => $requestdata];
            return successResponse(config("constants.SUCCESS_TO_KEY_TO_GIVE"), $data);
        } catch (\Exception $e) {
            //or $e->getMessage() if you want to get exact error
            return errorResponse(config("constants.ERROR_TO_KEY_TO_GIVE"));
    ...
    public function userLoginFailed()
    {
        try {
            ...
            return successResponse(config("constants.SUCCESS_TO_KEY_TO_GIVE"), ['throttles' => $throttles]);
        } catch (\Exception $e) {
            //or $e->getMessage() if you want to get exact error
            return errorResponse(config("constants.ERROR_TO_KEY_TO_GIVE"));
        }
    ...
    public function ignoreExpired($id)
    {
        try {
            ...
            return successResponse(config("constants.ERROR_TO_KEY_TO_GIVE"), []);
        } catch (\Exception $e) {
            //or $e->getMessage() if you want to get exact error
            return errorResponse(config("constants.ERROR_TO_KEY_TO_GIVE"));
        }
